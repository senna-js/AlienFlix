...
import { getImageUrl, getPopular, getTopRated, getUpcoming } from "@/lib/tmdb";
...
export default function MoviesPage() {
  ...
  const handleCategoryChange = (
    newCategory: "popular" | "top_rated" | "upcoming",
  ) => {
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8">
            ...
            <div className="flex space-x-2">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm ${category === "upcoming" ? "bg-red-600 text-white" : "bg-gray-800 text-gray-300 hover:bg-gray-700"}`}
              >
                Upcoming
              </button>
            </div>
